...
tests =
    describe "RobotSimulator"
        ...
        , skip <| describe "advance positive north"
            [ test "coordinates" <|
                \() ->
                    Robot North { x = 0, y = 0 }
                        |> advance
        ...
        , skip <| describe "advance positive east"
            [ test "coordinates" <|
                \() ->
                    Robot East { x = 0, y = 0 }
                        |> advance
        ...
        , skip <| describe "advance negative south"
            [ test "coordinates" <|
                \() ->
                    Robot South { x = 0, y = 0 }
                        |> advance
        ...
        , skip <| describe "advance positive west"
            [ test "coordinates" <|
                \() ->
                    Robot West { x = 0, y = 0 }
                        |> advance
